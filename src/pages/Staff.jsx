...
const itemData = [
  {
    id: '1',
    img: 'src/assets/system/staff1.jpg',
    title: 'Julia Salas',
    profession: 'Terapista',
  },
  {
    id: '2',
    img: 'src/assets/system/staff2.jpg',
    title: 'Maria Sotomayor',
    profession: 'Pisocología',
  },
  {
    id: '3',
    img: 'src/assets/system/staff3.jpg',
  ...
  return (
    <>
      {/* <Grid container marginTop='20px' p='30px 50px' columnSpacing={10}>
        ...
        <Grid item xs={12} md={6}>
          <img src='src/assets/system/terapias.jpg'  width='100%' style={{ height: '80vh' }} />
        </Grid>
      </Grid> */}
